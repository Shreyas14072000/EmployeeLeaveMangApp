...
Param(
    ...
    [string] $ResourceGroupName = 'EmployeeLeaveMangSystem-RG',
    [switch] $UploadArtifacts,
    [string] $StorageAccountName,
    [string] $StorageContainerName = $ResourceGroupName.ToLowerInvariant() + '-stageartifacts',
    [string] $TemplateFile = 'sms.servicebus.queue.json',
    [string] $TemplateParametersFile = 'sms.servicebus.queue.parameters.json',
